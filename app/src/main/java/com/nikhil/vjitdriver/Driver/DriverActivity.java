package com.nikhil.vjitdriver.Driver;
...
import com.nikhil.vjitdriver.LoginActivity;
import com.nikhil.vjitdriver.MapsActivity;
import com.nikhil.vjitdriver.Notifications.APIService;
import com.nikhil.vjitdriver.Notifications.Client;
import com.nikhil.vjitdriver.Notifications.Data;
import com.nikhil.vjitdriver.Notifications.MyResponse;
import com.nikhil.vjitdriver.Notifications.Sender;
import com.nikhil.vjitdriver.Notifications.Token;
...
public class DriverActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        if (dataSnapshot.exists()) {
                            for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                                ...
                                String no = preferences.getString("Bus", "");
                                if (!no.isEmpty()) {
                                    Data data = new Data(fuser.getUid(), R.drawable.ic_bus, no, "VJIT TRANSIT" + " " + "Help", userid);
                                    Sender sender = new Sender(data, Objects.requireNonNull(token).getToken());
                                    apiService = Client.getClient("https://fcm.googleapis.com/").create(APIService.class);
        ...
        if (firebaseUser != null) {
            ...
            referenc = FirebaseDatabase.getInstance().getReference("mainUsers").child(userid);
            ...
            public void onClick(View v) {
                ...
                if (!bus.isEmpty()) {
                    ...
                    if (firebaseUser != null) {
                        ...
                        reference = FirebaseDatabase.getInstance().getReference("mainUsers").child(userid);
