                                                            ...
                                                            public void onComplete(@NonNull Task<Void> task) {
                                                                if (task.isSuccessful()) {
                                                                    if (!user.getUid().isEmpty()){
                                                                        a = FirebaseDatabase.getInstance().getReference("mainUsers").child(user.getUid());
            ...
            public void onClick(View v) {
                if (check.isChecked()) {
                    ...
                    if (!sid.isEmpty()) {
                        ...
                        DatabaseReference ref = FirebaseDatabase.getInstance().getReference("mainUsers").child(sid);
