package com.nikhil.vjitdriver.ui.profile;
...
import com.nikhil.vjitdriver.Driver.ProfileActivity;
...
public class ProfileFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        if (fuser != null) {
            ...
            assert fuser != null;
            reference = FirebaseDatabase.getInstance().getReference("mainUsers").child(fuser.getUid());
